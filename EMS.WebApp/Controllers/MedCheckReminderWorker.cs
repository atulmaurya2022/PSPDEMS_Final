...
namespace EMS.WebApp.Controllers
{
    public sealed class MedCheckReminderWorker : BackgroundService
    {
        ...
        private readonly ILogger<MedCheckReminderWorker> _logger;

        public MedCheckReminderWorker(IServiceScopeFactory scopeFactory, ILogger<MedCheckReminderWorker> logger)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                {
                    _logger.LogError(ex, "Error occurred in MedCheckReminderWorker background service.");
