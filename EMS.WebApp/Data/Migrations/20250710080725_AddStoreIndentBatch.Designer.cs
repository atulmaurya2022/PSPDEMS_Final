...
namespace EMS.WebApp.Data.Migrations
{
    ...
    [Migration("20250710080725_AddStoreIndentBatch")]
    partial class AddStoreIndentBatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMS.WebApp.Data.ExpiredMedicine", b =>
                {
                    b.Property<int>("ExpiredMedicineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("expired_medicine_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ExpiredMedicineId"));
                    ...
                    b.Property<string>("BiomedicalWasteIssuedBy")
                        .HasMaxLength(100)
                        .IsUnicode(false)
                        .HasColumnType("varchar(100)")
                        .HasColumnName("biomedical_waste_issued_by");

                    b.Property<DateTime?>("BiomedicalWasteIssuedDate")
                        .HasColumnType("datetime2")
                    ...
                    b.Property<int>("CompounderIndentItemId")
                        .HasColumnType("int")
                    ...
                    b.HasKey("ExpiredMedicineId");

                    b.HasIndex("BatchNumber")
                        .HasDatabaseName("IX_ExpiredMedicine_BatchNumber");

                    b.HasIndex("CompounderIndentItemId")
                        .IsUnique()
                    ...
                    b.ToTable("expired_medicine", (string)null);
                });
            ...
            modelBuilder.Entity("EMS.WebApp.Data.MedMaster", b =>
                {
                    ...
                    b.HasIndex("MedItemName", "BaseId", "CompanyName")
                        ...
                        .HasFilter("[company_name] IS NOT NULL");

                    b.ToTable("med_master", (string)null);
                });

            modelBuilder.Entity("EMS.WebApp.Data.MedPrescription", b =>
                {
            ...
            modelBuilder.Entity("EMS.WebApp.Data.OthersDiagnosis", b =>
                {
                    ...
                    b.HasIndex("ApprovalStatus", "VisitType")
            ...
            modelBuilder.Entity("EMS.WebApp.Data.StoreIndentBatch", b =>
                {
                    ...
                    b.ToTable("store_indent_batch", (string)null);
                });
            ...
            modelBuilder.Entity("EMS.WebApp.Data.ExpiredMedicine", b =>
                {
                    b.HasOne("EMS.WebApp.Data.CompounderIndentItem", "CompounderIndentItem")
                        .WithMany()
                        .HasForeignKey("CompounderIndentItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompounderIndentItem");
                });
            ...
            modelBuilder.Entity("EMS.WebApp.Data.MedPrescriptionDisease", b =>
                {
                    ...
                    b.HasOne("EMS.WebApp.Data.MedPrescription", "MedPrescription")
            ...
            modelBuilder.Entity("EMS.WebApp.Data.StoreIndentBatch", b =>
                {
                    b.HasOne("EMS.WebApp.Data.StoreIndentItem", "StoreIndentItem")
                        .WithMany()
                        .HasForeignKey("IndentItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StoreIndentItem");
                });
