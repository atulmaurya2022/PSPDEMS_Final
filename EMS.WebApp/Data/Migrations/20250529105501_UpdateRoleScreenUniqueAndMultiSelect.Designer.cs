...
namespace EMS.WebApp.Data.Migrations
{
    ...
    [Migration("20250529105501_UpdateRoleScreenUniqueAndMultiSelect")]
    partial class UpdateRoleScreenUniqueAndMultiSelect
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EMS.WebApp.Data.SysAttachScreenRole", b =>
                {
                    ...
                    b.HasOne("EMS.WebApp.Data.sys_screen_name", "sys_screen_name")
                        .WithMany("SysAttachScreenRole")
                        .HasForeignKey("screen_uid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SysRole");

                    b.Navigation("sys_screen_name");
                });
